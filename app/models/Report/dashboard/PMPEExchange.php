<?php
class PMPEExchange extends Tile
{
	public $col = [
		'Date'			=> [
			'view'		=> 'Date',
		...
		'ExternalId'	=> [
			'view'		=> 'External Id',
			'fieldName'		=> 'a.EXTERNAL_IDENTIFIER',
		...
		'PCConversions'	=> [
			'view'		=> 'PC Conversions',
			'fieldName'		=> 'SUM(a.PC_CONVERSIONS)',
			'fieldAlias'	=> 'POST_CLICK_CONVERSION',
			'group'			=> false,
			'join'			=> false,
			'format'		=> 'number',
			'order'			=> false,
		...
		'PVConversions'  => [
			'view'	=> 'PV Conversions',
			'fieldName'		=> 'sum(a.PV_CONVERSIONS)',
			'fieldAlias'	=> 'POST_VIEW_CONVERSION',
			'group'			=> false,
			'join'			=> false,
			'format'		=> 'number',
			'order'			=> false,
		...
		'CPA'			=> [
			'view'		=> 'CPA',
			'fieldName'		=> 'CASE WHEN sum(a.PC_CONVERSIONS+a.PV_CONVERSIONS) > 0 THEN (sum(a.MEDIA_COST)/sum(a.PC_CONVERSIONS+a.PV_CONVERSIONS)) ELSE 0.00 END',
			'fieldAlias'	=> 'CPA',
			'group'			=> false,
			'join'			=> false,
			'format'		=> 'money',
	...
	protected $from = 'PMPE_EXCHANGE_DEAL a';
	...
	public function setQuery($options)
	{
		...
		array_walk($options['filters']['Columns'], array(&$this, 'addDataColumn'));
	}
}
